...
CREATE TABLE pacientes (
    ...
    FOREIGN KEY (medico_id,nome, especialidade) REFERENCES medico (medico_id, especialidade),
...
INSERT INTO medico(medico_id, medico_nome,sobrenome,especialidade) VALUES ('1', 'Carlos', 'Alberto','Pediatria');
INSERT INTO medico(medico_id, medico_nome,sobrenome,especialidade) VALUES ('2', 'Daniel', 'Ribeiro','Clínica Geral');
INSERT INTO medico(medico_id, medico_nome,sobrenome,especialidade) VALUES ('3', 'Ricardo', 'Gomes','gastrenterologia ');
INSERT INTO medico(medico_id, medico_nome,sobrenome,especialidade) VALUES ('4', 'Gabriel', 'Alencar','dermatologia');
INSERT INTO medico(medico_id, medico_nome,sobrenome,especialidade) VALUES ('5', 'Guilherme', 'Coelho','Cardiologia');
INSERT INTO medico(medico_id, medico_nome,sobrenome,especialidade) VALUES ('6', 'João', 'Barroso','Plástica');
INSERT INTO medico(medico_id, medico_nome,sobrenome,especialidade) VALUES ('7', 'Ligia', 'Turenen','Endoscopia');
INSERT INTO medico(medico_id, medico_nome,sobrenome,especialidade) VALUES ('8', 'Emanuel', 'Santos','Geriatria');
INSERT INTO medico(medico_id, medico_nome,sobrenome,especialidade) VALUES ('9', 'Simone', 'Salvador','Infectologia');
INSERT INTO medico(medico_id, medico_nome,sobrenome,especialidade) VALUES ('10', 'Emilly', 'Martins','Patologia');
...
INSERT INTO consultas(consultas_id, data,hora, valor, paciente_id, paciente_nome,sobrenome, convenio_id,medico_id, especialidade, remedio_id) VALUES ('1','21:10','30/11/2021','1.000,00','1','Roberto','Carlos','2','3','gastrenterologia','1');
INSERT INTO consultas(consultas_id, data,hora, valor, paciente_id, paciente_nome,sobrenome, convenio_id,medico_id, especialidade, remedio_id) VALUES ('2','11:00','20/11/2021','600,00', '2','Daniel','Junior','2','4','dermatologia','2 ');
INSERT INTO consultas(consultas_id, data,hora, valor, paciente_id, paciente_nome,sobrenome, convenio_id,medico_id, especialidade, remedio_id) VALUES ('3','13:20','2/9/2021','1.000,00','3', 'Guilherme','Pimentel','2','3','gastrenterologia','3');
INSERT INTO consultas(consultas_id, data,hora, valor, paciente_id, paciente_nome,sobrenome, convenio_id,medico_id, especialidade, remedio_id) VALUES ('4','15:30','20/8/2021','900,00', '4','Guilherme','Knip','3','4','dermatologia','4');
INSERT INTO consultas(consultas_id, data,hora, valor, paciente_id, paciente_nome,sobrenome, convenio_id,medico_id, especialidade, remedio_id) VALUES ('5','16:10','21/7/2021','1.000,00','3', 'Kayque','moital','2','8','Geriatria','3');
INSERT INTO consultas(consultas_id, data,hora, valor, paciente_id, paciente_nome,sobrenome, convenio_id,medico_id, especialidade, remedio_id) VALUES ('6','7:10','19/10/2020','1.000,00','5','Caio','Henrique','2','9','Infectologia','2 ');
INSERT INTO consultas(consultas_id, data,hora, valor, paciente_id, paciente_nome,sobrenome, convenio_id,medico_id, especialidade, remedio_id) VALUES ('7','17:20','23/9/2020','1.000,00','8','João','Barroso','8','8','Geriatria','1');
INSERT INTO consultas(consultas_id, data,hora, valor, paciente_id, paciente_nome,sobrenome, convenio_id,medico_id, especialidade, remedio_id) VALUES ('8','23:10','1/8/2020','1.000,00','9','Enzo','Bernardo','9','9','Infectologia','2');
INSERT INTO consultas(consultas_id, data,hora, valor, paciente_id, paciente_nome,sobrenome, convenio_id,medico_id, especialidade, remedio_id) VALUES ('9','00:10','5/7/2020','1.000,00','10','Matheus','Carlos','2','6','Plástica','3');
INSERT INTO consultas(consultas_id, data,hora, valor, paciente_id, paciente_nome,sobrenome, convenio_id,medico_id, especialidade, remedio_id) VALUES ('10','10:10','10/7/2020','1.000,00','11','Camilly','Ferreira','7','5','Cardiologia','4');
INSERT INTO consultas(consultas_id, data,hora, valor, paciente_id, paciente_nome,sobrenome, convenio_id,medico_id, especialidade, remedio_id) VALUES ('11','8:45','15/7/2020','1.000,00','12','Emilly','Manuela','7','6','Plástica','1');
INSERT INTO consultas(consultas_id, data,hora, valor, paciente_id, paciente_nome,sobrenome, convenio_id,medico_id, especialidade, remedio_id) VALUES ('12','9:10','23/11/2021','1.000,00','13','Ligia','Santos','2','5','Cardiologia','2');
INSERT INTO consultas(consultas_id, data,hora, valor, paciente_id, paciente_nome,sobrenome, convenio_id,medico_id, especialidade, remedio_id) VALUES ('13','11:32','24/10/2021','1.000,00','14','Luiza','Silva','4','2','Clínica Geral','1');
INSERT INTO consultas(consultas_id, data,hora, valor, paciente_id, paciente_nome,sobrenome, convenio_id,medico_id, especialidade, remedio_id) VALUES ('14','22:45','3/10/2021','1.000,00','15','Gustavo','Bizarria','4','1','Pediatria','5');
INSERT INTO consultas(consultas_id, data,hora, valor, paciente_id, paciente_nome,sobrenome, convenio_id,medico_id, especialidade, remedio_id) VALUES ('15','20:20','1/9/2021','1.000,00','6','Pedro','Santos','2','2','Clínica Geral','Amantadina');
INSERT INTO consultas(consultas_id, data,hora, valor, paciente_id, paciente_nome,sobrenome, convenio_id,medico_id, especialidade, remedio_id) VALUES ('16','21:10','30/11/2017','1.000,00','1', 'Guilherme','Pimentel','2','1','Pediatria','3');
INSERT INTO consultas(consultas_id, data,hora, valor, paciente_id, paciente_nome,sobrenome, convenio_id,medico_id, especialidade, remedio_id) VALUES ('17','01:10','2/11/2017','1.000,00','4','Guilherme','Knip','3','2','Clínica Geral','4');
INSERT INTO consultas(consultas_id, data,hora, valor, paciente_id, paciente_nome,sobrenome, convenio_id,medico_id, especialidade, remedio_id) VALUES ('18','06:10','1/10/2017','1.000,00','3','5','Caio','Henrique','2','5','Cardiologia','2 ');
INSERT INTO consultas(consultas_id, data,hora, valor, paciente_id, paciente_nome,sobrenome, convenio_id,medico_id, especialidade, remedio_id) VALUES ('19','14:10','7/9/2017','1.000,00','9','Enzo','Bernardo','9','3','gastrenterologia','1');
INSERT INTO consultas(consultas_id, data,hora, valor, paciente_id, paciente_nome,sobrenome, convenio_id,medico_id, especialidade, remedio_id) VALUES ('20','15:10','17/10/2016','1.000,00','15','Gustavo','Bizarria','4','5','Cardiologia','5');
...
INSERT INTO tipo_quarto(tipo_quarto_id,descrição,valor_diaria, quarto_id) VALUES ('1', 'apartamento', '500,00',' 1');
INSERT INTO tipo_quarto(tipo_quarto_id,descrição,valor_diaria, quarto_id) VALUES ('2', 'Quarto Duplo', '1000,00', '2');
INSERT INTO tipo_quarto(tipo_quarto_id,descrição,valor_diaria, quarto_id) VALUES ('3', 'Enfermaria', '300,00', '4');
INSERT INTO tipo_quarto(tipo_quarto_id,descrição,valor_diaria, quarto_id) VALUES ('4', 'apartamento', '500,00', 3);
INSERT INTO tipo_quarto(tipo_quarto_id,descrição,valor_diaria, quarto_id) VALUES ('5', 'apartamento conjunto', '600,00', '5');
INSERT INTO tipo_quarto(tipo_quarto_id,descrição,valor_diaria, quarto_id) VALUES ('6', 'apartamento', '500,00', '3');
INSERT INTO tipo_quarto(tipo_quarto_id,descrição,valor_diaria, quarto_id) VALUES ('7', 'Enfermaria', '300,00', '4');
